...
_baseUniform = ["LOP_U_ISTS_Fatigue_01","LOP_U_ISTS_Fatigue_02","LOP_U_ISTS_Fatigue_03","LOP_U_ISTS_Fatigue_04"];
_baseHelmet = ["LOP_H_Pakol","LOP_H_Turban","LOP_H_Turban_mask","H_ShemagOpen_tan","H_ShemagOpen_khk"];
_baseGlasses = [];
...
// Pilot
_pilotUniform = ["LOP_U_ISTS_Fatigue_01","LOP_U_ISTS_Fatigue_02","LOP_U_ISTS_Fatigue_03","LOP_U_ISTS_Fatigue_04"];
...
// Crewman
_crewUniform = ["LOP_U_ISTS_Fatigue_01","LOP_U_ISTS_Fatigue_02","LOP_U_ISTS_Fatigue_03","LOP_U_ISTS_Fatigue_04"];
_crewHelmet = ["rhs_tsh4"];
_crewRig = ["LOP_6sh46"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["LOP_U_ISTS_Fatigue_01","LOP_U_ISTS_Fatigue_02","LOP_U_ISTS_Fatigue_03","LOP_U_ISTS_Fatigue_04"];
_ghillieHelmet = ["LOP_H_Pakol","LOP_H_Turban","LOP_H_Turban_mask","H_ShemagOpen_tan","H_ShemagOpen_khk"];
